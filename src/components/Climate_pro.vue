<template>
  <div class="Climate_router_con">
    <div id="map_con"></div>
    <transition name="slide-fade">
      <div class="tab" v-show="this.$store.state.Climatedatashow">
...
<script>
  export default {
    ...
    mounted() {
      this.$store.state.Climatedatashow = true;
      this.$store.state.weatherlistIndex = 8;
      //改变地图风格
