<template>
  <div class="His_router_con">
    <div id="map_con"></div>
    <div class="timesliderpicker">
      <timeslider></timeslider>
    </div>
      <transition name="slide-fade">
        <div class="tab" v-show="this.$store.state.Hisdatashow">
...
<script>
  ...
  export default {
    ...
    mounted(){
      this.$store.state.Hisdatashow = true;
      this.$store.state.weatherlistIndex = 3;
      //改变地图风格
